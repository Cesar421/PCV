...
for i = 1:size(Image1Conditioned,2)    
    A(i, :) = [Image1Conditioned(1, i)*Image2Conditioned(1, i), ...
        ...
        Image2Conditioned(1, i), ...
        Image1Conditioned(1, i)*Image2Conditioned(2, i), ...
        Image1Conditioned(2, i)*Image2Conditioned(2, i), ...
        Image2Conditioned(2, i), ...
        Image1Conditioned(1, i), Image1Conditioned(2, i), 1];
end
...
Image1TranslatedMatrix = [1, 0, 0, -Image1Midpoint(1,1); 
    ...
    0, 0, 1, -Image1Midpoint(3,1); 0, 0, 0, 1];
...
Image1Conditioned = [Image1Translated(1,:)*Image1TransformationMatrix(1,1); 
    Image1Translated(2,:)*Image1TransformationMatrix(2,2); 
    Image1Translated(3,:)*Image1TransformationMatrix(3,3)];
Image2Conditioned = [Image2Translated(1,:)*Image2TransformationMatrix(1,1); 
    Image2Translated(2,:)*Image2TransformationMatrix(2,2); 
...
for i = 1:size(Image1Conditioned, 2)    
    ...
    % Each row represents an equation derived from 
    % the homography constraints
    A = [A; 
        -Image1Conditioned(1, i), -Image1Conditioned(2, i), ...
        -Image1Conditioned(3, i), -1, zeros(1, 4), zeros(1, 4), ...
        Image1Conditioned(1, i) * Image2Conditioned(1, i), ...
        Image1Conditioned(2, i) * Image2Conditioned(1, i), ...
        Image1Conditioned(3, i) * Image2Conditioned(1, i), ...
        Image2Conditioned(1, i);
        zeros(1, 4), -Image1Conditioned(1, i), -Image1Conditioned(2, i), ...
        -Image1Conditioned(3, i), -1, zeros(1, 4), ...
        Image1Conditioned(1, i) * Image2Conditioned(2, i), ...
        Image1Conditioned(2, i) * Image2Conditioned(2, i), ...
        Image1Conditioned(3, i) * Image2Conditioned(2, i), ...
        Image2Conditioned(2, i);
        zeros(1, 4), zeros(1, 4), -Image1Conditioned(1, i), ...
        -Image1Conditioned(2, i), -Image1Conditioned(3, i), -1, ...
        Image1Conditioned(1, i) * Image2Conditioned(3, i), ...
        Image1Conditioned(2, i) * Image2Conditioned(3, i), ...
